...
| [NPC_TEAM.md](./NPC_TEAM.md) | NPC Team 总指挥 — 一句话调用内置 NPC_TEAM Skill（`.codebuddy/skills/npc-team/`）或粘贴提示词，让官方免费 CodeBuddy 化身 6 专家跑完整研发流程（零平台积分） |
<!-- 审查报告已归档 -->
...
| 文档 | 说明 |
|------|------|
| [MCP.md](./MCP.md) | Model Context Protocol 文档 |
| [POWERSHELL_COM.md](./POWERSHELL_COM.md) | PowerShell COM 桥接技术 |
| [SKILLS.md](./SKILLS.md) | OpenCode Skills 文档 |
...
├── NPC_TEAM.md             # NPC Team 总指挥（Skill 一键调用 / 提示词驱动官方 CodeBuddy 化身，零积分全流程）
...
├── MCP.md                  # MCP 协议
├── POWERSHELL_COM.md       # PowerShell COM 桥接
