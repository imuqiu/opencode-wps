...
/**
 * 所有MCP Tools集合（注册工具数 = excelTools + wordTools + pptTools + commonTools，见下方分类；另含 12 个内置工具 + ~257 个 Gateway COM Actions）
 ...
 *   3. COM Actions（~257个，在 gateway/index.ts 索引，通过 Gateway 按需加载）
 *
 * 直接注册工具分类：
